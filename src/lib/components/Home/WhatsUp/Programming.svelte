...
<p class="text-sm text-gray-400 leading-normal">
  ...
  <a class="link inline-flex items-center space-x-1" target="_blank" rel="noopener" href="https://wakatime.com/@plibither8">
    <span>Wakatime</span>
  ...
  {#each data.languages as { name, time, percent, color }}
    <div class="relative w-full p-3">
      <div
        ...
        style="background: {color}; width: {percent / data.languages[0].percent * 100}%"
      />
      <p class="flex items-baseline justify-between text-gray-300 transform translate-x-0">
