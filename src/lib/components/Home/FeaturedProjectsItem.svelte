...
>
  ...
  <div class="transform translate-x-0 space-y-3">
    <div class="flex justify-between items-center">
      ...
      <button
        class="p-2 -m-2 text-gray-300 hover:text-white"
    ...
    {#if expanded}
      <div transition:slide={{ duration: 100 }}>
        <p class="text-gray-400 text-sm leading-normal">
          ...
          excepturi consequatur officiis delectus veniam atque exercitationem
          neque sequi aspernatur tempore, itaque, culpa, facilis velit. Suscipit
          fugit delectus consequuntur laborum ex.
        </p>
      </div>
    {/if}
  </div>
